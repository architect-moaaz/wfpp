...
function App() {
  ...
  if (loading) {
    return <div className="app-loading"><div className="loading-spinner"></div><p>Loading calm_hawk...</p></div>;
  }
  ...
  return (
    <div className="app">
      <nav className="sidebar">
        <div className="logo"><h2>calm_hawk</h2></div>
      ...
      <main className="main-content">
        <Routes>
          <Route path="/" element={defaultPage ? <Navigate to={defaultPage.route} replace /> : <div className="empty-state"><h2>Welcome to calm_hawk</h2><p>No pages configured.</p></div>} />
