...
function App() {
  ...
  if (loading) {
    return <div className="app-loading"><div className="loading-spinner"></div><p>Loading eager_giraffe...</p></div>;
  }
  ...
  return (
    <div className="app">
      <nav className="sidebar">
        <div className="logo"><h2>eager_giraffe</h2></div>
      ...
      <main className="main-content">
        <Routes>
          <Route path="/" element={defaultPage ? <Navigate to={defaultPage.route} replace /> : <div className="empty-state"><h2>Welcome to eager_giraffe</h2><p>No pages configured.</p></div>} />
