...
function App() {
  ...
  if (loading) {
    return <div className="flex items-center justify-center h-screen bg-background"><div className="text-center"><div className="w-8 h-8 border-2 border-primary border-t-transparent rounded-full animate-spin mx-auto"></div><p className="mt-4 text-muted-foreground">Loading eager_koala...</p></div></div>;
  }
    ...
    <div className="flex min-h-screen bg-background">
      <nav className="border-r bg-card flex flex-col" style={{ width: '240px' }}>
        <div className="p-6 border-b">
          <h2 className="text-xl font-bold tracking-tight">eager_koala</h2>
        </div>
      ...
      <main className="flex-1 overflow-auto" style={{ padding: '24px' }}>
        ...
        <Routes>
          <Route path="/" element={defaultPage ? <Navigate to={defaultPage.route} replace /> : <div className="flex flex-col items-center justify-center h-full"><h2 className="text-2xl font-semibold">Welcome to eager_koala</h2><p className="text-muted-foreground mt-2">No pages configured.</p></div>} />
