...
function App() {
  ...
  if (loading) {
    return <div className="app-loading"><div className="loading-spinner"></div><p>Loading test-app...</p></div>;
  }
  ...
  return (
    <div className="app">
      <nav className="sidebar">
        <div className="logo"><h2>test-app</h2></div>
      ...
      <main className="main-content">
        <Routes>
          <Route path="/" element={defaultPage ? <Navigate to={defaultPage.route} replace /> : <div className="empty-state"><h2>Welcome to test-app</h2><p>No pages configured.</p></div>} />
