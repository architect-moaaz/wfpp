...
function App() {
  ...
  if (loading) {
    return <div className="app-loading"><div className="loading-spinner"></div><p>Loading fancy_lion...</p></div>;
  }
  ...
  return (
    <div className="app">
      <nav className="sidebar">
        <div className="logo"><h2>fancy_lion</h2></div>
      ...
      <main className="main-content">
        <Routes>
          <Route path="/" element={defaultPage ? <Navigate to={defaultPage.route} replace /> : <div className="empty-state"><h2>Welcome to fancy_lion</h2><p>No pages configured.</p></div>} />
